...
[![Build Status](https://travis-ci.org/wouterz/go-libxml2.svg?branch=master)](https://travis-ci.org/wouterz/go-libxml2)

[![GoDoc](https://godoc.org/github.com/wouterz/go-libxml2?status.svg)](https://godoc.org/github.com/wouterz/go-libxml2)

Interface to libxml2, with DOM interface.

## Why?

I needed to write [go-xmlsec](https://github.com/wouterz/go-xmlsec). This means we need to build trees using libxml2, and then muck with it in xmlsec: Two separate packages in Go means we cannot (safely) pass around `C.xmlFooPtr` objects (also, you pay a penalty for pointer types). This package carefully avoid references to `C.xmlFooPtr` types and uses uintptr to pass data around, so other libraries that needs to interact with libxml2 can safely interact with it.
...
import (
  ...
  "github.com/wouterz/go-libxml2"
  "github.com/wouterz/go-libxml2/xsd"
)
...
ok      github.com/wouterz/go-libxml2  37.597s
```

## See Also

* https://github.com/wouterz/go-xmlsec
